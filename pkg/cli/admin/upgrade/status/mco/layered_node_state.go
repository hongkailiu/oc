...
const (
	...
	ReasonOfUnavailabilityNodeNotReady           = "Node is not ready"
	ReasonOfUnavailabilityNodeDiskPressure       = "Node is running out disk"
	ReasonOfUnavailabilityNodeNetworkUnavailable = "Node's network is unavailable"
)
